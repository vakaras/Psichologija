...
\newglossaryentry{psichiniai_procesai}{
  ...
  description={
    ...
    išoriniams ar vidiniams dirginimams ir baigiasi jiems nutrūkus
    },
  sort={psichiniai procesai}
  }

\newglossaryentry{siela}{
  name=siela,
  description={
    vidinis pasaulis, psichika (DLKŽ); daugumoje religijų vadinama
    savarankiška substancija, egzistuojanti kiekvieno žmogaus viduje,
    laikoma kūno ir materijos priešingybe (Vikipedija)
    },
  sort=siela
  }

\newglossaryentry{weber-fechner}{
  name={Vėberio-Fechnerio dėsnis},
  description={ % vis dar nesuprantama formuluotė
    dirginimo pokyčio ir kiekio santykio pojūtis yra konstantinis
    (pavyzdžiui, pinigų pokytis padalintas iš pinigų kiekio yra konstanta)
    },
  sort={Vėberio-Fechnerio dėsnis}
  }

\newglossaryentry{nuotaika}{
  name={nuotaika},
  description={
    pastovi emocinė būsena, veikianti laikyseną (DLKŽ)
    },
  sort=nuotaika
  }

\newglossaryentry{afektas}{
  name=afektas,
  description={
    stiprus susijaudinimas, susierzinimas, valios nevaldomas jausmo 
    protrūkis, jautulys (DLKŽ)
    },
  sort=afektas
  }

\newglossaryentry{aistra}{
  name=aistra,
  description={
    stiprus patraukimas, geidulys (DLKŽ)
    },
  sort=aistra
  }

\newglossaryentry{stresas}{
  name=stresas,
  description={
    netikėtų, dažniausiai neigiamų aplinkybių sukelti organizmo funkcijų
    ir žmogaus veiklos sutrikimai (DLKŽ)
    },
  sort=stresas
  }

\newglossaryentry{igudis}{
  name=įgūdis,
  description={
    suautomatintas sąmoningos veiklos komponentas
    },
  sort=įgūdis
  }

\newglossaryentry{iprotis}{
  name=įprotis,
  description={
    suautomatintas veiklos komponentas susijęs su poreikiu jį kartoti
    },
  sort=įprotis
  }
