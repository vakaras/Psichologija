...
%veiklos ir individualių savybių dar vadinamas apercèpcija. (DLKŽ)

Bendrieji suvokimo (pagavos), kaip \emph{atspindžio}, dėsniai:
\begin{enumerate}
  \item \emph{apercepciškas} (suvokimui turi įtakos anksčiau žmogaus
    įgyta patirtis, pavyzdžiui, apercepcijos veikiamas matematikas
    žodį „šaknis“ suvoks kitaip, nei botanikas);
